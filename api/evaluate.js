...
- Règle stricte de cohérence physique et matérielle : L'IA doit impérativement vérifier si le type d'emballage et ses matériaux permettent RÉELLEMENT de réaliser la fonction proposée dans le monde réel. Si la fonction est physiquement impossible, absurde ou inutile dans le cycle d'usage réel, elle doit être notée INCORRECTE.
  Exemples d'absurdités physiques à sanctionner :
  * Un filet (mesh bag), un panier ajouré ou une cagette en bois ne peuvent pas "Protéger de la pluie/de l'humidité/de la poussière/de la lumière" à cause de leurs ouvertures physiques/mailles.
  * Un emballage plastique, verre, carton classique ou métallique standard ne peut pas "Isoler des flammes / du feu / de la chaleur extrême" (ce ne sont pas des emballages ignifugés/pare-feu).
  * Une bouteille d'eau classique n'a pas à être protégée des rayonnements ionisants (hors sujet / sur-dimensionnement absurde).
  Dans ces cas, explique la contrainte physique ou le problème de pertinence dans "comm" (ex: "Un filet possède des mailles ouvertes et ne protège pas de l'eau/de la pluie") et écris "Non applicable" dans "sugg". Attribue "hors_sujet" à "error_type".
